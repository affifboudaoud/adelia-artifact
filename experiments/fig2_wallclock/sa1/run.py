...
if __name__ == "__main__":
    ...
    if args.benchmark_mode:
        ...
        run_benchmark(dalia_fd, dalia_jax, args, "sa1")
        exit(0)
    ...
    if args.framework_comparison:
        ...
        run_framework_comparison(dalia_jax, dalia_fd, args, "sa1")
        exit(0)
    ...
    if not args.skip_jax:
        ...
        write_optimization_result(
            args.results_csv, "sa1", "jax_autodiff", results_jax,
    ...
    if not args.skip_fd:
        ...
        write_optimization_result(
            args.results_csv, "sa1", "finite_diff", results_fd,
