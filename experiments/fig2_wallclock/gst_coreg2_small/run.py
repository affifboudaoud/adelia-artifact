...
if __name__ == "__main__":
    print_msg("--- gst_coreg2_small: Coregional (2-variate) Spatio-Temporal Model ---")
    ...
    if args.framework_comparison:
        ...
        run_framework_comparison(dalia_jax, dalia_fd, args, "gst_coreg2_small")
        exit(0)
    ...
    write_optimization_result(
        args.results_csv, "gst_coreg2_small", "jax_autodiff", results_jax,
    ...
    if not args.skip_fd:
        ...
        write_optimization_result(
            args.results_csv, "gst_coreg2_small", "finite_diff", results_fd,
    ...
    if args.output_dir:
        ...
        jax_data = collect_optimization_results(dalia_jax if 'dalia_jax' in dir() else dalia_fd, "gst_coreg2_small", "jax_autodiff", t_total_jax, jit_time=t_first_jax)
        write_results_json(jax_data, args.output_dir, "gst_coreg2_small", "jax_autodiff")
