...
if __name__ == "__main__":
    print_msg("--- ap1: Coregional (3-variate) Spatio-Temporal Model (distributed, 4 nodes) ---")
    ...
    if args.benchmark_mode:
        ...
        run_benchmark(dalia_fd, dalia_jax, args, "ap1")
        exit(0)
    ...
    if not args.skip_jax:
        ...
        write_optimization_result(
            args.results_csv, "ap1", "jax_autodiff", results_jax,
    ...
    if not args.skip_fd:
        ...
        write_optimization_result(
            args.results_csv, "ap1", "finite_diff", results_fd,
